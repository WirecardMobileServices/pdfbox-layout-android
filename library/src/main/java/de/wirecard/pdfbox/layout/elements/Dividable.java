...
public interface Dividable {
     ...
     *
     * @param remainingHeight the remaining height on the page dictating the height of the
     *                        first part.
     * @param nextPageHeight  the height of the next page allows to make better decisions on
