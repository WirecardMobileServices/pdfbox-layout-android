...
public class Stroke {
    ...
    public static class DashPattern {
         ...
         * 0.
         *
         * @param onOff the length of the on/off part.
         */
         ...
         * phase 0.
         *
         * @param on  the length of the off part.
         * @param off the length of the off part.
         */
         ...
         * @param on    the length of the off part.
         * @param off   the length of the off part.
         * @param phase the phase to start the pattern with.
         */
