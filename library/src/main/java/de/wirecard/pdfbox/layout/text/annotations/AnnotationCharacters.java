...
import de.wirecard.pdfbox.layout.text.ControlCharacter;
import de.wirecard.pdfbox.layout.text.ControlCharacters.ControlCharacterFactory;
import de.wirecard.pdfbox.layout.text.annotations.Annotations.AnchorAnnotation;
import de.wirecard.pdfbox.layout.text.annotations.Annotations.HyperlinkAnnotation;
...
public class AnnotationCharacters {
     ...
     *
     * @param <T> the type of the annotation control character.
     */
