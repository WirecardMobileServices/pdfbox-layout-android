...
import de.wirecard.pdfbox.layout.elements.Cutter;
import de.wirecard.pdfbox.layout.elements.Dividable;
import de.wirecard.pdfbox.layout.elements.Dividable.Divided;
import de.wirecard.pdfbox.layout.elements.Drawable;
import de.wirecard.pdfbox.layout.elements.Element;
import de.wirecard.pdfbox.layout.elements.PageFormat;
import de.wirecard.pdfbox.layout.elements.VerticalSpacer;
...
public class VerticalLayout implements Layout {
     ...
     *
     * @param removeLeadingEmptyLines <code>true</code> if space should be removed.
     */
