...
import de.wirecard.pdfbox.layout.shape.Rect;
import de.wirecard.pdfbox.layout.shape.Shape;
...
public class Frame implements Element, Drawable, WidthRespecting, Dividable {
     ...
     *
     * @param inner the item to contain.
     */
     ...
     *
     * @param inner  the item to contain.
     * @param width  the width to constrain the border-box of the frame to, or
     *               <code>null</code>.
     ...
     *
     * @param borderStroke the stroke to use.
     */
     ...
     * @param borderStroke the stroke to use.
     */
    public void setBorder(@ColorInt int borderColor, Stroke borderStroke) {
     ...
     *
     * @param other the frame to copy the attributes to.
     */
     ...
     *
     * @param absolutePosition the absolute position to use, or <code>null</code>.
     */
